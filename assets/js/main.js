		...
		var header =
			'<div class="dropdown">'
		  		...
		  		+'<div id="myDropdown" class="dropdown-content">'
		    		+'<a class="fa fa-calendar-o" href="#" onclick="schedule(); toggleDropdown();">SCHEDULE</a>'
		    		+'<a class="fa fa-qrcode" href="#" onclick="qrcode(); toggleDropdown();">QR CODES</a>'
		    		+'<a class="fa fa-map" href="#" onclick="map(); toggleDropdown();">FESTIVAL MAP</a>'
		    		+'<a class="fa fa-lightbulb-o" href="#" onclick="information(); toggleDropdown();">INFORMATION</a>'
		    		+'<a class="fa fa-comments" href="#" onclick="messages(); toggleDropdown();">MESSAGES</a>'
		    		+'<a class="fa fa-user" href="#" onclick="profile(); toggleDropdown();">Profile</a>'
